...
__global__ void kernel1(Tensor<__half, 2> T0, Tensor<__half, 1> T1, Tensor<__half, 1> T2, Tensor<__half, 2> T20, Tensor<float, 2> T29, Tensor<float, 2> T31) {
  ...
  for(nvfuser_index_t i172 = 0; i172 < 10; ++i172) {
    int i222;
    i222 = (((i172 + nvfuser_zero) * (ceilDiv((ceilDiv(T0.size[1], 8)), 10))) + ((nvfuser_index_t)threadIdx.x)) * 8;
    if (((((((i172 + nvfuser_zero) * (ceilDiv((ceilDiv(T0.size[1], 8)), 10))) + ((nvfuser_index_t)threadIdx.x)) * 8) + 7) < T0.size[1])) {
      loadGlobalToLocal<__half, 8, false>(&T25[(i172 * 8)],  &T0[(((nvfuser_index_t)blockIdx.x) * T0.size[1]) + i222]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO
  float T6[1];
  ...
  for(nvfuser_index_t i175 = 0; i175 < 10; ++i175) {
    if (((((((i175 + nvfuser_zero) * (ceilDiv((ceilDiv(T0.size[1], 8)), 10))) + ((nvfuser_index_t)threadIdx.x)) * 8) + 7) < T0.size[1])) {
      #pragma unroll
      for(nvfuser_index_t i177 = 0; i177 < 8; ++i177) {
        float T3[1];
        T3[0]
           = __half2float(T25[((i175 * 8) + i177)]);
        welfordCombine (
          T35[0],
          T33[0],
          T34[0],
  ...
  T30[0]
     = T9[0];
  if ((((nvfuser_index_t)threadIdx.x) == 0)) {
  ...
  for(nvfuser_index_t i190 = 0; i190 < 10; ++i190) {
    int i414;
    i414 = (((i190 + nvfuser_zero) * (ceilDiv((ceilDiv(T0.size[1], 8)), 10))) + ((nvfuser_index_t)threadIdx.x)) * 8;
    if (((((((i190 + nvfuser_zero) * (ceilDiv((ceilDiv(T0.size[1], 8)), 10))) + ((nvfuser_index_t)threadIdx.x)) * 8) + 7) < T0.size[1])) {
      Array<__half, 8, 8> T27;
      T27.set(0);
      loadGlobalToLocal<__half, 8, false>(&T27[0],  &T2[i414]);
      Array<__half, 8, 8> T26;
      T26.set(0);
      loadGlobalToLocal<__half, 8, false>(&T26[0],  &T1[i414]);
      ...
      loadLocalToGlobal<__half, 8, false>( &T20[(((nvfuser_index_t)blockIdx.x) * T0.size[1]) + i414], &T28[0]);
    } else {
      Array<__half, 8, 8> T27;
      T27.set(0);
      if (((((((i190 + nvfuser_zero) * (ceilDiv((ceilDiv(T0.size[1], 8)), 10))) + ((nvfuser_index_t)threadIdx.x)) * 8) + 7) < T0.size[1])) {
