...
__global__ void kernel1(Tensor<float, 2> T0, Tensor<float, 1> T2, Tensor<float, 1> T3, Tensor<int, 1> T4) {
  NVFUSER_DEFINE_MAGIC_ZERO
  Array<float, ((7 * (ceilDiv(32, 4))) * 4), 4> T1;
  #pragma unroll
  for(nvfuser_index_t i20 = 0; i20 < 8; ++i20) {
    int i44;
    i44 = 4 * i20;
    bool b251;
    b251 = (3 + (4 * (i20 + nvfuser_zero))) < 32;
    #pragma unroll
    for(nvfuser_index_t i22 = 0; i22 < 4; ++i22) {
      if (b251) {
        T2[(i44 + (i22 + nvfuser_zero))] = 0.00000000000000000e+00;
      }
    }
  }
  ...
  for(nvfuser_index_t i20 = 0; i20 < 8; ++i20) {
    ...
    i62 = 4 * i20;
    bool b286;
    b286 = (3 + (4 * (i20 + nvfuser_zero))) < 32;
    #pragma unroll
    for(nvfuser_index_t i22 = 0; i22 < 4; ++i22) {
      if (b286) {
        T3[(i62 + (i22 + nvfuser_zero))] = 0.00000000000000000e+00;
      }
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO
  ...
  for(nvfuser_index_t i20 = 0; i20 < 8; ++i20) {
    ...
    i80 = 4 * i20;
    bool b321;
    b321 = (3 + (4 * (i20 + nvfuser_zero))) < 32;
    #pragma unroll
    for(nvfuser_index_t i22 = 0; i22 < 4; ++i22) {
      if (b321) {
        T4[(i80 + (i22 + nvfuser_zero))] = 0;
      }
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO
  #pragma unroll
  for(nvfuser_index_t i19 = 0; i19 < 7; ++i19) {
    int i104;
    i104 = 32 * i19;
    #pragma unroll
    for(nvfuser_index_t i20 = 0; i20 < 8; ++i20) {
      int i105;
      i105 = 4 * (i20 + nvfuser_zero);
      int i128;
      i128 = 4 * i20;
      int i130;
      i130 = i104 + i128;
      ...
      b370 = (3 + i105) < 32;
      if (b370) {
        loadGlobalToLocal<float, 4, false>(&T1[i130],  &T0[(i104 + i105)]);
      }
      if (b370) {
        int i410;
        i410 = T4[((4 * i20) + (0 + nvfuser_zero))] + 1;
        float f414;
        f414 = (float)(i410);
        float f415;
        f415 = 1 / f414;
        ...
        for(nvfuser_index_t i22 = 0; i22 < 4; ++i22) {
          int i180;
          i180 = i128 + (i22 + nvfuser_zero);
          welfordVectorized<float>(T2[i180], T3[i180], T4[i180], T1[(i130 + i22)], f415, i410);
        }
      }
    }
  }
